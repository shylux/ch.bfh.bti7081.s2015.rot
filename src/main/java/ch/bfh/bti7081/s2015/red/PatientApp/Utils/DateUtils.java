...
public class DateUtils {
    ...
    /**
     * <p>Checks if the first date is before today.</p>
     * @param date1 the first date, not altered, not null
    ...
    public static boolean isBeforeToday(Date date1) {
        ...
        return isBeforeDay(date1, Calendar.getInstance().getTime());
    }
     ...
     * @throws IllegalArgumentException if the date is <code>null</code>
     */
    public static boolean isAfterToday(Date date1) {
        if (date1 == null) {
            throw new IllegalArgumentException("The date must not be null");
        }
        return isAfterDay(date1, Calendar.getInstance().getTime());
    }
